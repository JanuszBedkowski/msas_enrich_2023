	...
	if(params.init){//} && all_points.size() == params.number_max_points_init ){
        ...
        for(int i = 0; i < all_points.size(); i+=2)
        {
            ...
            if(all_points[i].point.z() > 0.2 && all_points[i].point.z() < 1.0){
                //if(all_points[i].point.x() > 0.1 && all_points[i].point.x() < 0.42){
                if(all_points[i].point.x() > 0.1 && all_points[i].point.x() < 0.6){
                ...
                if(all_points[i].point.x() > -0.7 && all_points[i].point.x() < -0.4){
                    if(all_points[i].point.y() > -0.25 && all_points[i].point.y() < 0.25){
                        std::cout << all_points[i].point.x() << " " << all_points[i].point.y() << " " << all_points[i].point.z() << std::endl;
                        count_back++;
                    }
